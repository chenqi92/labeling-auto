...
export default function Login() {
  ...
  return (
    <div data-theme="dark" style={{ height: '100vh', display: 'grid', gridTemplateColumns: '1.15fr .85fr', background: 'var(--bg)', color: 'var(--text)' }}>
      {/* 品牌侧 */}
      <div style={{ position: 'relative', background: 'radial-gradient(120% 90% at 20% 10%,#0f2a2e 0%,#0a0f16 55%,#070a10 100%)', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '54px 60px' }}>
        ...
        <div style={{ fontSize: 11, color: 'var(--text3)' }}>© 2026 VisLab · 内网视觉智能平台 · v2.4.0</div>
      ...
      {/* 表单侧 */}
      <div style={{ background: 'var(--chrome)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 40 }}>
        <div style={{ width: 340 }}>
